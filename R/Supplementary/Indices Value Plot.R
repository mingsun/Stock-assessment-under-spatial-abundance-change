...
png("manuscript/3. stock assessment with spatial abundance change/plot/SA/S1 SF_FALL_indices.png",  width = 8, height = 5, units = 'in', res = 800)
print(SF_FALL)
dev.off()
...
png("manuscript/3. stock assessment with spatial abundance change/plot/SA/S2 SF_SPRING_indices.png",  width = 8, height = 5, units = 'in', res = 800)
print(SF_SPRING)
dev.off()
...
png("manuscript/3. stock assessment with spatial abundance change/plot/SA/S3 LS_FALL_indices.png",  width = 8, height = 5, units = 'in', res = 800)
print(LS_FALL)
dev.off()
...
png("manuscript/3. stock assessment with spatial abundance change/plot/SA/S4 LS_SPRING_indices.png",  width = 8, height = 5, units = 'in', res = 800)
print(LS_SPRING)
dev.off()
...
png("manuscript/3. stock assessment with spatial abundance change/plot/SA/S5 SC_indices.png",  width = 8, height = 5, units = 'in', res = 800)
print(SC_PLOT)
dev.off()
